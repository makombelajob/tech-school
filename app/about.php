    ...
    <main>
        ...
        <section id="partenaire" class="row text-center">
            ...
            <article class="col-md-4 m-auto">
                <figure class="">
                    <img class="w-25 rounded-circle" src="assets/partenaire/image1.png" alt="logo d'un partenaire">
                    <figcaption class="">
            ...
            <article class="col-md-4 my-3">
                <figure class="">
                    <img class="w-25 rounded-circle" src="assets/partenaire/image2.png" alt="logo d'un partenaire">
                    <figcaption class="">
                        <h3>Partenaires-Wead</h3>
                        <p>Lorem ipsum dolor sit amet.</p>
                    </figcaption>
            ...
            <article class="col-md-4 my-3">
                <figure class="">
                    <img class="w-25 rounded-circle" src="assets/partenaire/image3.png" alt="logo d'un partenaire">
                    <figcaption class="">
                        <h3>Partenaires-Wead</h3>
                        <p>Lorem ipsum dolor sit amet.</p>
                    </figcaption>
            ...
            <article class="col-md-4 my-3">
                <figure class="">
                    <img class="w-25 rounded-circle" src="assets/partenaire/image4.png" alt="logo d'un partenaire">
                    <figcaption class="">
                        <h3>Partenaires-Wead</h3>
                        <p>Lorem ipsum dolor sit amet.</p>
                    </figcaption>
            ...
            <article class="col-md-4 my-3">
                <figure class="">
                    <img class="w-25 rounded-circle" src="assets/partenaire/image5.png" alt="logo d'un partenaire">
                    <figcaption class="">
                        <h3>Partenaires-Wead</h3>
                        <p>Lorem ipsum dolor sit amet.</p>
                    </figcaption>
            ...
            <article class="col-md-4 my-3">
                <figure class="">
                    <img class="w-25 rounded-circle" src="assets/partenaire/image6.png" alt="logo d'un partenaire">
                    <figcaption class="">
                        <h3>Partenaires-Wead</h3>
                        <p>Lorem ipsum dolor sit amet.</p>
                    </figcaption>
